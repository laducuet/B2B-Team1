    ...
    <div class="container-lg text-center shadow p-5 mt-4 mb-4 border-3">
        <div class="text-center">
            <?php if (isset($_SESSION['Ordersuccess']) && $_SESSION['Ordersuccess'] == 'true'): ?>
                <div class="alert alert-success m-auto mb-5" style="width: 50%;" role="alert">Order Done Successfully
                </div>
            ...
            <?php elseif (isset($_SESSION['Ordersuccess']) && $_SESSION['Ordersuccess'] === 'false'): ?>
                <?php if ($_SESSION['orderStatus'] == 0): ?>
                    <div class="alert alert-danger m-auto mb-5" style="width: 50%;" role="alert">Selected quantity no
                        longer available!
                        Item is sold out.. Order can't be done
                    </div>
                    <?php unset($_SESSION['Ordersuccess']); ?>
                <?php else: ?>
                    <div class="alert alert-danger m-auto mb-5" style="width: 50%;" role="alert">Selected quantity no
                        longer available!
                        Only <?php echo $_SESSION['orderStatus'] ?> Left.. Order can't be done
                    </div>
                    <?php unset($_SESSION['Ordersuccess']); ?>
                <?php endif; ?>
            <?php endif; ?>
