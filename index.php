                        ...
                        <div class="sidebar-widget">
                            ...
                            <ul>
                                <?php foreach ($categories as $cat): ?>
                                    <li style="text-align:left;padding-bottom:12px;padding-left:25px;"><a
                                                href="<?php echo "childcat.php?cat=" . urlencode($cat['categoryId']); ?>"
                                                style="font-weight:bold;font-family:candara;font-size:16px;"><?php echo $cat['categoryName'] ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <div class="product">
                                ...
                                <div class="product-detail"
                                    ...
                                    <a href="<?php echo "childcat.php?cat=" . urlencode($cat['categoryId']); ?>"
                                       style="font-family:candara;">VIEW MORE</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
