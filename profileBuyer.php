                ...
                echo '
                    <div class="col-lg-3 m-0 text-center">
                        <div class="card m-md-auto shadow" style="width: 18rem;">
                                '; ?>
                <a href="reviewItem.php?do=Manage&itemId=<?= $orderedItem->itemId ?>&itemName=<?= $orderedItem->title ?>"
