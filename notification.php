        ...
        <div class="row  justify-content-center">
            <div class="col-lg-9">
                <?php if ($_SESSION['noOfNewNotification'] == 0 && $_SESSION['noOfOldNotification'] == 0): ?>
                    <div class="alert alert-info m-auto mb-5 text-center" role="alert" style="width: 50%;" role="alert">
                        No
                        Notifications yet
                    </div>
                <?php endif; ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <a type="button"
                                                                       href="notification.php?likes=true&id=<?php echo $noti['sellerId'] ?>"
                                                                       class="btn btn-success" data-bs-dismiss="">Like
                                                                        <i
                                                                                class="bi bi-hand-thumbs-up-fill"></i></a>
                                                                    <a type="button"
                                                                       href="notification.php?dislikes=true&id=<?php echo $noti['sellerId'] ?>"
                                                                       class=" btn
