                                ...
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" placeholder="" name="firstname"
                                               value="<?php echo $bill[0]['firstname'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" placeholder="" name="lastname"
                                               value="<?php echo $bill[0]['lastname'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" placeholder="" name="companyname"
                                               value="<?php echo $bill[0]['companyname'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" placeholder="Street address" name="address"
                                               value="<?php echo $bill[0]['address'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        <input type="text" placeholder="Apartment, suite, unit etc. (optional)"
                                               name="optional" value="<?php echo $bill[0]['optional'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                ...
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" placeholder="Postcode / Zip" name="postcode"
                                               value="<?php echo $bill[0]['postcode'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                ...
                                <div class="order-notes">
                                    <div class="checkout-form-list">
                                        ...
                                        <textarea id="checkout-mess" name="notes" cols="30" rows="10"
                                                  ...
                                                  value="<?php echo $bill[0]['notes'] ?>"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
